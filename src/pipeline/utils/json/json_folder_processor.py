...
class JsonFolderProcessor:
    ...
    def __init__(self, jsons_dir_path, to_shape_lab, pipeline=['write_original_image', 'write_reshaped_b64json'], ext='JPG', ALLOWED_CLASSES = []):
    ...
    def reshape_single_json_annot(self, labelme_json_path):
        ...
        new_shapes = JsonFolderProcessor.get_resized_shapes(dic['shapes'], wratio, hratio, ALLOWED_CLASSES)
    ...
    @staticmethod
    def get_resized_shapes(old_shapes, w_ratio, h_ratio, ALLOWED_CLASSES):
        """
        format of `shapes`
        ...
        for any_cls_dic in old_shapes:
            ...
            if __temp['label'] in ALLOWED_CLASSES:
