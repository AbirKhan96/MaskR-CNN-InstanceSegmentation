...
def get_im_seg_info(images_dir, predictor, save_dir, THING_CLASSES, ext='jpg'):
	...
	print (start_time)
	for im_name in tqdm(os.listdir(images_dir)[0:500]):
		# if 'TrackZ_' not in im_name:
		# 	continue
		print (im_name)
...
get_im_seg_info("/mnt/PCMC/03.Output/Pegasus_Bulk Processed Data/For_Orbit/Manapa_Bhavan_Zone/2021-APR-09_pcmcMission1_53018/Images/JPG/", predictor, "Manapa_Bhavan_Zone_15Aug", THING_CLASSES, ext='jpg')
